...
/**
 * Full-text search that returns per-match highlight rectangles (in normalized page coordinates),
 * by capturing each glyph's [TextPosition] via a custom stripper. Rectangles are approximate:
 * a match spanning a line break is merged into one box, and rotated pages aren't corrected.
 */
...
/**
 * Extracts the plain text of a single [pageIndex] (0-based) for the "copy text" panel. Returns an
